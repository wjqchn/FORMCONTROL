; FormControl 安装脚本（本地服务 + 单文件 HTML 方案）
; 默认安装到 C:\Users\Public\FORMCONTROL，桌面快捷方式启动本地数据服务 FormControl.exe，
; 服务自动打开浏览器并在 http://127.0.0.1 上托管 HTML；业务数据落盘到 安装路径\data.sqlite。
...
Source: "..\build\dist_release\FormControl.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{userdesktop}\质量文控平台 - 表格分类汇总"; Filename: "{app}\FormControl.exe"; Parameters: "{app}"; WorkingDir: "{app}"; IconFilename: "{app}\图标.ico"
